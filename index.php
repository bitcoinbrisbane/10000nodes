...
<body>
    ...
    <section id="story-freext">
        <article>
           <h3><i class="glyphicon glyphicon-signal"></i>Increasing the number of full nodes</h3>
           <span>
                At the time of writing the number of full bitcoin nodes < 7000.
            </span>
        </article>
    ...
    <!--PARALLAX SECTION TWO -->
     <section id="story-two">
        <article>
            <span>
                From March 2014 to October 2014 there has been a decline in full nodes from 10,000 to 7,000.  Full bitcoin nodes are <b>critical</b> to security and success of bitcoin.
                The more full copies of the block chain there are in existance, the harder the network is to shut down.
            </span>
            <h3>Goal</h3>
